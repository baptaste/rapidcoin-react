    ...
    <header className="header">
      <nav className="header__nav">
        <div className="header__menu">
          ...
          <Link to="/" onClick={resetFilter} className="header__menu-desktopBtn">Cryptocurrencies</Link>
          {/* <NavLink exact to="/categories"  className="header__menu-desktopBtn" activeClassName="header__menu-desktopBtn--active">Categories</NavLink> */}
